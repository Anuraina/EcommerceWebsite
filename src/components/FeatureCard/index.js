    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          {
            cards?.map((card) => { // If the cards variable is not null or undefined, the map() method will be called on the array. For each card in the cards array, the code inside the arrow function will be executed
              return (
